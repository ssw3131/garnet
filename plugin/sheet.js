			...
			(function(){
				...
				function update(){
					...
					while( i-- ){
						...
						if( data.jArr == null ) return;
						if( ++data.cr % data.fr < 1 ) ++data.cf > data.ef ? data.rp ? data.cf = data.sf : ( sheet.data.cf = sheet.data.ef, render.del( sheet.pp( "ssId" ) ) ) : null, goFrame( sheet );
					}
				}
